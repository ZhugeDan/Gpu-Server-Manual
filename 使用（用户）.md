...
在**自己本地的 命令行(不是登录到自己的容器！）**里用 接下里的SCP命令：

​	1.先cd到本地文件夹，注意例如cde盘符之间切换要先D: ，盘符内之后再cd进入。

​	2.在要上传的文件的地址栏里输入cmd或者powershell，
...
![image-20260312184938690](../obsidian/photo/image-20260312184938690.png)
...
**2.用任意终端ssh连接（cmd，powershell）：**

pycharm的用户名要和容器表中的名字一致

![image-20260312190034389](../obsidian/photo/image-20260312190034389.png)



![image-20260312190311309](../obsidian/photo/image-20260312190311309.png)

![image-20260312190355670](../obsidian/photo/image-20260312190355670.png)



![image-20260312190421432](../obsidian/photo/image-20260312190421432.png)
...
![image-20260312190647995](../obsidian/photo/image-20260312190647995.png)
...
![image-20260312190857262](../obsidian/photo/image-20260312190857262.png)
