...
这次经历，全程在genmi的帮助下完成。这是[聊天记录](https://gemini.google.com/share/ad342085855f)，附带全部的细节。

分为部署，使用，可能遇到的问题三个文件，以及接下来的QA。
...
1. **Q:** **为什么要引入lxc？lxc加上conda虚拟环境，相当于两层隔离**。
...
2. **Q: lxc的模板，复制后可以共享给其他人什么？****
   ...
   **注意：** 复制完成的那一刻起，张三的容器就独立了。张三以后在里面装的游戏，不会出现在“始祖巨人”里，也不会出现在“李四”那里。
